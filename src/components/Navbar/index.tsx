...
const Navbar: React.FC<INavbarProps> = ({ isOpen, toggleSidebar, setIsOpen }) => {
    return (
        ...
        >
            <div className="flex justify-center md:justify-start items-center relative w-full md:w-auto">
                {isOpen ? <GrClose
            ...
            <nav className="w-[100%] h-[100%] text-[18px] md:h-auto flex flex-col md:flex-row align-center items-center justify-end gap-10">
                <Link
