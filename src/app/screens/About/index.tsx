...
export default function About() {
    return (
        <div className="px-4 py-10 text-xl text-left bg-white min-h-[60vh] w-[100%] flex flex-col md:flex-row" id="biografia">
            ...
            <div className="min-w-[50%] flex flex-col md:gap-4 leading-6 justify-between">
