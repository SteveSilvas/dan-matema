...
const Partner: React.FC = () => {
    ...
    const renderItems = () => {
        return partners.map((partner) => (
            <div
                ...
                className={`w-full md:w-1/4 min-h-64 md:min-h-90 text-[18px] md:text-[16px]bg-white shadow-lg rounded-lg p-4 transition-all duration-100 animate-${animateDirection}`}
            >
    ...
    return (
        <div id="parceiros" className="bg-white w-full h-full min-h-screen py-10">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center p-4 w-full mx-auto">
                {renderItems()}
            </div>
        </div>
    );
